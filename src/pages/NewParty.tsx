    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setFormData({
          ...
          selfLD: party.selfLD || { M: '', S: '', A: '', T: '', C: '' },
          agentLD: party.agentLD || { name: '', M: '', S: '', A: '', T: '', C: '' },
          thirdPartyLD: party.thirdPartyLD || { name: '', M: '', S: '', A: '', T: '', C: '' },
          selfCommission: party.selfCommission || { M: '', S: '' },
          agentCommission: party.agentCommission || { M: '', S: '' },
          thirdPartyCommission: party.thirdPartyCommission || { M: '', S: '' }
        });
